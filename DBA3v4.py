...
class CombatOutcomeCounts(object):
        ...
        if Defender.type == 'CAVALRY':
            if Attacker.type == 'PIKES' or Attacker.type == 'SPEARS'  or Attacker.type == 'HORDES':
                if Defender.terrain == 'good-going':
                    ...
                    self.numWinDouble += 1
        elif Defender.type == 'LIGHT HORSE':
    ...
    def applyWinCase(self,Attacker,Defender):
        if Defender.type == 'ELEPHANTS':
            ...
            if Defender.terrain == 'bad-going':
                ...
                self.numWin += 1
        elif Defender.type == 'SPEARS' or Defender.type == 'PIKES' or Defender.type == 'BLADES':
    ...
    def applyTieCase(self,Attacker,Defender):
        if Attacker.type == 'SCYTHED CHARIOTS':
            ...
            self.numWinDouble += 1
        elif (Attacker.type == 'KNIGHTS' or Attacker.type == 'CAMELRY') and (Defender.type != 'KNIGHTS' and Defender.type != 'CAMELRY'):
            if Defender.type == 'BLADES' or Defender.code.find('Lb') > -1 or Defender.code.find('Cb') > -1:
                ...
                self.numTie += 1
        elif (Defender.type == 'KNIGHTS' or Defender.type == 'CAMELRY') and (Attacker.type != 'KNIGHTS' and Attacker.type != 'CAMELRY'):
            if Attacker.type == 'BLADES' or Attacker.code.find('Lb') > -1 or Attacker.code.find('Cb') > -1:
                ...
                self.numTie += 1
        elif (Defender.type == 'KNIGHTS' or Defender.type == 'CAMELRY') and (Attacker.type == 'KNIGHTS' or Attacker.type == 'CAMELRY'):
            self.numTie += 1
        elif Attacker.code == '4Kn' and Defender.code == '3Kn':
            self.numLose += 1
        elif Defender.code == '4Kn' and Attacker.code == '3Kn':
            self.numWin += 1
        elif Attacker.style == 'mounted' and Attacker.type != 'KNIGHTS' and Attacker.type != 'CAMELRY':
            ...
            if Attacker.style == 'foot' and Attacker.classification == 'Solid':
                ...
                self.numTie += 1
        elif Attacker.style == 'foot' and Attacker.classification == 'Fast':
            if Defender.style == 'foot' and Defender.classification == 'Solid':
                self.numLose += 1
            else:
                self.numTie += 1
    ...
    def applyLoseCase(self,Attacker,Defender):
        if Attacker.type == 'ELEPHANTS':
            ...
            if Attacker.terrain == 'bad-going':
                ...
                self.numLose += 1
        elif Attacker.type == 'LIGHT HORSE':
            if Attacker.terrain == 'bad-going':
                self.numFlee += 1
            elif Defender.type == 'SCYTHED CHARIOTS':
                self.numFlee += 1
                ...
                self.numLose += 1
        elif Attacker.type == 'SPEARS' or Attacker.type == 'PIKES' or Attacker.type == 'BLADES':
    ...
    def getRearSupportFactorVs(self,Enemy):
        if self.hasRearSupport:
            if self.type == 'PIKES':
                ...
                rearSupport = 1
            elif self.code == '6Kn' or self.code == '6Cv' or self.code == '8Sp' or self.code == '6Bd' or self.code == '8Bw':
                if Enemy.style == 'foot' and self.terrain == 'good-going':
                    rearSupport = 1
                else:
                    rearSupport = 0
            else:
